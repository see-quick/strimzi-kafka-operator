...
class AlternativeReconcileTriggersST extends AbstractST {
    ...
    void testManualTriggeringRollingUpdate(ExtensionContext extensionContext) {
        ...
        InternalKafkaClient internalKafkaClient = new InternalKafkaClient.Builder()
            .withUsingPodName(kubeClient(namespaceName).listPodsByPrefixInNameWithDynamicWait(namespaceName, kafkaClientsName).get(0).getMetadata().getName())
    ...
    void setup(ExtensionContext extensionContext) {
        // TODO: make installation with possible of configuring timeouts...
